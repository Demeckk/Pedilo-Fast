                ...
                <?php
                    ...
                    foreach($tablaStock as $db){
                        if($db['Cantidad']<$db['aviso']) { 
                            array_push($bajoStock, $db['Nombre']);
                        }//Si el stock es bajo guardar los nombres
                        ...
                        <a style="cursor: pointer;" onclick="subtractStock('.$db['Cod_producto'].','.$db['Cod_sucursal'].')">
                            <span class="material-symbols-outlined"  style="background:red;">remove</span>
                        </a>
                    </td>
                        </tr>';
                        $n++;
